...
> This document provides a list of the required technologies for anyone who is training on the Pega track. It details why each technology is required and provides some step-by-step instructions on how to install and configure the technologies. This guide also walks you through any needed environment setup.
...
- **Spring Tool Suite 4**: We will be using Spring Tool Suite 4 as our _integrated development environment_ (IDE). Though you don't need an IDE to write code, an IDE provides several features that make rapid development (e.g. quickly writing and refactoring code) easier.
...
1. Via a _package manager_ or command-line installer
...
### Step 9: Install PostgreSQL (Optional)
